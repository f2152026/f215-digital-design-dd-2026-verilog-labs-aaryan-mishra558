module cla64_flat(
  ...
  // Remaining carries follow exactly the same direct CLA pattern.
  ...
  // For the remaining carries, use the equivalent direct Boolean form.
  // This is intentionally written as a continuous assignment with delay.
